...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    IQKeyboardManagerObj.toolbarManageBehaviour              = IQAutoToolbarBySubviews;
    IQKeyboardManagerObj.shouldToolbarUsesTextFieldTintColor = NO;
    IQKeyboardManagerObj.shouldShowTextFieldPlaceholder      = YES;
    IQKeyboardManagerObj.canAdjustTextView                   = YES;
